...
4. Select **Settings > Devices > Bluetooth & other devices** and make sure the controllers are listed as paired. If not, [pair them](motion-controller-problems.md#how-do-i-pair-my-controllers-again-after-the-initial-setup). 
